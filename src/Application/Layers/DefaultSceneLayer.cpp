...
void DefaultSceneLayer::_CreateScene()
{
	...
	else
	{
		...
		MeshResource::Sptr monkeyScanMesh = ResourceManager::CreateAsset<MeshResource>("MonkeyScanner.obj");

		// Load in some textures
		Texture2D::Sptr    boxTexture = ResourceManager::CreateAsset<Texture2D>("textures/box-diffuse.png");
		Texture2D::Sptr    basicTexture = ResourceManager::CreateAsset<Texture2D>("textures/basic.png");
		...
		Material::Sptr basicMaterial = ResourceManager::CreateAsset<Material>(basicShader);
		{
			basicMaterial->Name = "Box";
			basicMaterial->Set("u_Material.Diffuse", basicTexture);
			basicMaterial->Set("u_Material.Shininess", 0.1f);
		}
		...
		scene->Lights[0].Position = glm::vec3(0.0f, 0.0f, 1.0f);
		scene->Lights[0].Color = glm::vec3(0.0f, 1.0f, 1.0f);
		scene->Lights[0].Range = 4.0f;
		scene->Lights[1].Position = glm::vec3(0.0f, 0.0f, 5.0f);
		scene->Lights[1].Color = glm::vec3(0.0f, 1.0f, 1.0f);
		scene->Lights[1].Range = 4.0f;
		scene->Lights[2].Position = glm::vec3(28.0f, 50.0f, 10.0f);
		...
		GameObject::Sptr plane = scene->CreateGameObject("Grass");
		{
			// Make a big tiled mesh
			MeshResource::Sptr tiledMesh = ResourceManager::CreateAsset<MeshResource>();
			tiledMesh->AddParam(MeshBuilderParam::CreatePlane(ZERO, UNIT_Z, UNIT_X, glm::vec2(100.0f), glm::vec2(20.0f)));
			tiledMesh->GenerateMesh();
			plane->SetScale(glm::vec3(10.f));
			plane->SetPostion(glm::vec3(0.f,0.f,-1.f));
		...
		GameObject::Sptr monkeyScan = scene->CreateGameObject("Monkey Scan");
		{
			// Set position in the scene
			monkeyScan->SetPostion(glm::vec3(0.0f, 0.0f, 0.0f));
			monkeyScan->SetRotation(glm::vec3(90.0f, 0.0f, -90.0f));
			monkeyScan->SetScale(glm::vec3(2.0f, 2.0f, 2.0f));

			// Create and attach a renderer for the monkey
			RenderComponent::Sptr renderer = monkeyScan->Add<RenderComponent>();
			renderer->SetMesh(monkeyScanMesh);
			renderer->SetMaterial(basicMaterial);

		}

		GameObject::Sptr particleGroup = scene->CreateGameObject("Particles");
		GameObject::Sptr particles = scene->CreateGameObject("Particles");
		{
			ParticleSystem::Sptr particleManager = particles->Add<ParticleSystem>();
			particleManager->AddEmitter(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 50.0f), 5.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleGroup->AddChild(particles);
		}
		GameObject::Sptr particles2 = scene->CreateGameObject("Particles");
		{
			...
			particleManager->AddEmitter(glm::vec3(0.5f, 0.5f, 0.0f), glm::vec3(0.0f, 0.0f, 47.0f), 4.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleGroup->AddChild(particles2);
		}
		GameObject::Sptr particles3 = scene->CreateGameObject("Particles");
		{
			ParticleSystem::Sptr particleManager = particles3->Add<ParticleSystem>();
			particleManager->AddEmitter(glm::vec3(-0.5f, -0.5f, 0.0f), glm::vec3(0.0f, 0.0f, 45.0f), 6.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleGroup->AddChild(particles3);
		}
		GameObject::Sptr particles4 = scene->CreateGameObject("Particles");
		{
			ParticleSystem::Sptr particleManager = particles4->Add<ParticleSystem>();
			particleManager->AddEmitter(glm::vec3(-0.5f, 0.5f, 0.0f), glm::vec3(0.0f, 0.0f, 47.0f), 6.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleGroup->AddChild(particles4);
		}
		GameObject::Sptr particles5 = scene->CreateGameObject("Particles");
		{
			ParticleSystem::Sptr particleManager = particles5->Add<ParticleSystem>();
			particleManager->AddEmitter(glm::vec3(0.5f, -0.5f, 0.0f), glm::vec3(0.0f, 0.0f, 50.0f), 6.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleGroup->AddChild(particles5);
		}
